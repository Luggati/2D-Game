...
public class Player{
	...
	Player(Level l) {	
		...
		this.posBonus = new Vec2(0, 0);
		this.posLastFrameBonus = new Vec2(0, 0);
		...
		try {
			...
			imageWalk = ImageIO.read(new File(Platformer.BasePath + "Player\\p3_walk\\PNG\\p3_walk01.png"));
			tilesWalk.add(imageWalk);
			imageHalf = ImageIO.read(new File(Platformer.BasePath + "Player\\p3_walk\\PNG\\p3_walk02.png"));
			tilesWalk.add(imageHalf);
			imageEmpty = ImageIO.read(new File(Platformer.BasePath + "Player\\p3_walk\\PNG\\p3_walk03.png"));
			tilesWalk.add(imageEmpty);
			imageWalk = ImageIO.read(new File(Platformer.BasePath + "Player\\p3_walk\\PNG\\p3_walk04.png"));
			tilesWalk.add(imageWalk);
			imageHalf = ImageIO.read(new File(Platformer.BasePath + "Player\\p3_walk\\PNG\\p3_walk05.png"));
			tilesWalk.add(imageHalf);
			imageEmpty = ImageIO.read(new File(Platformer.BasePath + "Player\\p3_walk\\PNG\\p3_walk06.png"));
			tilesWalk.add(imageEmpty);
			imageWalk = ImageIO.read(new File(Platformer.BasePath + "Player\\p3_walk\\PNG\\p3_walk07.png"));
			tilesWalk.add(imageWalk);
			imageHalf = ImageIO.read(new File(Platformer.BasePath + "Player\\p3_walk\\PNG\\p3_walk08.png"));
			tilesWalk.add(imageHalf);
			imageEmpty = ImageIO.read(new File(Platformer.BasePath + "Player\\p3_walk\\PNG\\p3_walk09.png"));
			tilesWalk.add(imageEmpty);
			imageWalk = ImageIO.read(new File(Platformer.BasePath + "Player\\p3_walk\\PNG\\p3_walk10.png"));
			tilesWalk.add(imageWalk);
			imageHalf = ImageIO.read(new File(Platformer.BasePath + "Player\\p3_walk\\PNG\\p3_walk11.png"));
			tilesWalk.add(imageWalk);
	...
	public void updatePosBonus() {
		...
		Vec2 b = posLastFrame;
		pos = posBonus;
		posLastFrame = posLastFrameBonus;
		posBonus = a;
		posLastFrameBonus = b;
	}
